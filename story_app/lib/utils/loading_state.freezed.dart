...
abstract class Initial<T> implements LoadingState<T> {
...
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$LoadingStateCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
abstract class Loaded<T> implements LoadingState<T> {
